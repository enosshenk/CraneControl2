...
int Channel[6] = {0, 0, 0, 0, 0, 0};     // Array for raw channel data
int ChannelLast[6] = {0, 0, 0, 0, 0, 0}; // Previous loop channel data
float ChannelF[6];  // Cleaned up array
bool Direction[6];  // Direction array
